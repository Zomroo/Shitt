...
app = Client('my_bot', api_id=15849735, api_hash="b8105dc4c17419dfd4165ecf1d0bc100", bot_token="6067171502:AAF20GwzoxblYC4yBNw8nTffRJprwgLTKi0")
...
def set_command_handler(client, message):
    ...
    if message.reply_to_message.video:
        ...
        os.system(f'ffmpeg -y -i "{video}" -vf "drawtext=text=@OnlyFanstash:x=w-tw-10:y=10:fontsize=40:fontcolor=white:box=1:boxcolor=black@0.5" -c:a copy output.mp4')
